...
public class DefaulterList extends javax.swing.JFrame {
    ...
    public void setIssueBookDetailsToTable(){
        ...
        try {
            ...
            PreparedStatement stmnt=con.prepareStatement("select * from issue_book_details where due_date < ? AND status = ? ");
            stmnt.setDate(1, todaysDate);
            stmnt.setString(2,"pending");
    ...
    private void initComponents() {
        ...
        jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/icons8_edit_property_50px.png"))); // NOI18N
        jLabel12.setText("Defaulter List");
        jPanel1.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 70, 220, 60));
